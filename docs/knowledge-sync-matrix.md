...
| `tools/agents/**` (new sub-command, new agent) | `docs/ai-sdet-tooling.md`, `tools/README.md`, `docs/interview-demo-guide.md` | Documentation Compliance |
...
| `docker-compose.yml`, `server/Dockerfile` | `README.md` (Docker / verify), `docs/architecture.md` (Phase 6), `docs/interview-demo-guide.md` | Backend Engineer |
| `scripts/verify.ps1`, `scripts/verify.sh` | `README.md` (Final verification), `docs/interview-demo-guide.md` | Verification / Review |
| `.gitignore` (`reports/`, `generated/`, `target/`) | `README.md` (note on ignored artifacts) | Documentation Compliance |
| `.github/workflows/ci.yml` | `README.md` (optional: mention CI), `docs/interview-project-summary.md` | Verification / Review |
| `docs/agent-workflow.md` (phase reconciliation / gates) | `docs/interview-project-summary.md` (optional cross-link) | Documentation Compliance |
